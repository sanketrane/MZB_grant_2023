...
Mathematical models are a natural language for addressing knowledge gaps such as these, and have been successfully applied in many settings to dissect the dynamics that regulate lymphocyte populations~\cite{Thomas_Vaslin_1989, Rolink_1999, Asquith_2002, Antia_2005, Anderson_2009, Dowling_2009, Johnson_2012, Meyer-Hermann_2012,   Westera_2013,   Gossel_2017, van_Hoeven_2017, Reynaldi_2019,  Verheijen_2020, DeBoer_2001,   De_Boer_2013,  Hogan_2015, Rane_2018, Rane_2022, Mold_2019}.
...
\includegraphics[width=0.31\textwidth]{Figures/develop_diag.png}
\vspace*{-7mm}
...
\centering
%\vspace*{1mm}t
\includegraphics[width=0.38\textwidth]{Figures/age_abm4.pdf}
\vspace*{-7mm}
\caption{
...
In addition, since the mosaic model compartmentalizes lymphocyte populations, it has significantly smaller computational load than typical stochastic simulation algorithms, such as agent-based models or Doob–Gillespie solvers, which track individual cells or reactions. % and therefore have heavy computational load. % instead of cohorts of cells binned as age-classes. 
...
%We will use Metropolis-Hastings algorithm to sample model parameters from the joint prior density.
...
\centering
\vspace*{-6mm}
\includegraphics[width=0.26\textwidth]{Figures/ODE_approx.pdf}
\vspace*{-7mm}
...
\blue{In such regimes, when age-classes in the mosaic model contain over thousands of cells, we will %use their mean-field approximations and will 
